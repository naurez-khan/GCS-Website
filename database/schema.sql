...
CREATE TABLE IF NOT EXISTS courses (
    ...
    class_tests_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    class_test_count INTEGER NOT NULL DEFAULT 0 CHECK (class_test_count BETWEEN 0 AND 100),
...
CREATE TABLE IF NOT EXISTS assignments (
    ...
    assessment_type VARCHAR(20) NOT NULL DEFAULT 'assignment' CHECK (assessment_type IN ('assignment', 'monthly_test', 'class_test')),
