...
const expected = {
    ...
    courses: ["id", "name", "course_code", "class_type", "intermediate_year", "class_shift", "roll_entry_mode", "roll_number_type", "approval_status", "approved_by", "approved_at", "monthly_tests_enabled", "class_tests_enabled", "class_test_count", "teacher_id", "roll_start", "roll_end", "result_code", "updated_at"],
