...
const expected = {
    ...
    courses: ["id", "name", "course_code", "class_type", "intermediate_year", "class_shift", "roll_entry_mode", "monthly_tests_enabled", "teacher_id", "roll_start", "roll_end", "result_code", "updated_at"],
