...
const expected = {
    ...
    courses: ["id", "name", "course_code", "class_type", "intermediate_year", "roll_entry_mode", "teacher_id", "roll_start", "roll_end", "result_code", "updated_at"],
    students: ["id", "course_id", "roll_number", "midterm_marks", "final_marks", "updated_at"],
    ...
    assignments: ["id", "course_id", "assignment_number", "name", "max_marks", "updated_at"],
